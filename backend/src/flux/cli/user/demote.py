"""Definition of the demote-subcommand."""
...
class Demote(Command):
    """Subcommand for demoting a user."""

    index_location = index_location
    verbose = verbose

    user = Argument("user", helptext="user to be demoted", nargs=1)
    ...
    def run(self, args):
        ...
        if verbose:
            print(f"User '{user}' demoted to regular user")
